"""
Contains statistical information about separate run
"""


class Run:
    def __init__(self, avg_fitness_list=None, std_fitness_list=None,  best_fitness_list=None,pressure_stats=None, reproduction_stats=None,
                 selection_diff_stats=None, noise_stats=None, is_successful=None):
