...
class PopulationFactory:
    ...
    def generate_population_fx(self, n, l, p_m, i):
        ...
        for y in fitness_list:
            x = round(y, 2)
            chromosomes.append(
                Chromosome(encode(x, self.fitness_function.a, self.fitness_function.b, l), float(x), start + 1))
            start = start + 1
    ...
    def generate_population_fx2(self, n, l, p_m, i):
        ...
        for y in fitness_list:
            ...
            chromosomes.append(
                Chromosome(encode(x, self.fitness_function.a, self.fitness_function.b, l), float(x ** 2), start + 1))
            start = start + 1
    ...
    def generate_population_fx4(self, n, l, p_m, i):
        ...
        for y in fitness_list:
            ...
            chromosomes.append(
                Chromosome(encode(x, self.fitness_function.a, self.fitness_function.b, l), float(x ** 4), start + 1))
            start = start + 1
